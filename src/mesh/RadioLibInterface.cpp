...
void RadioLibInterface::setTransmitDelay()
{
    ...
    if (p->tx_after) {
        ...
        recorded_delay = p->tx_after - now;
        notifyLater(recorded_delay, TRANSMIT_DELAY_COMPLETED, false);
